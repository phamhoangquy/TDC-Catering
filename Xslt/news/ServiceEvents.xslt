	...
	<xsl:template match="/">
		<section class="service-events">
			<div class="container">
				...
				<xsl:apply-templates select="/ZoneList/Zone[1]/News" mode="Zone-News1"></xsl:apply-templates>
			</div>
		</section>
				...
				<div class="sv-events-2-swiper-wrapper">
					...
					<div class="swiper-container">
						<div class="swiper-wrapper">
							<xsl:apply-templates select="/ZoneList/Zone[2]/News" mode="Slide-2"></xsl:apply-templates>
						</div>
					</div>
				</div>
